  ...
  return (
    ...
    >
      ...
      <FormFieldMedia
        ...
        errorMessage={sectionErrors?.background?.message}
        isRequired
        inlineButtonText="Choose Image"
        placeholder=" "
        type="images"
        onFieldChange={(e) => setValue("background", e.target.value)} // temporary workaround before refactoring FormFieldMedia
      />
      <br />
      <>
