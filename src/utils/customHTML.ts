...
/**
 * Custom HTML tags supported by our CMS.
 * Note: Custom HTML tags should contain a "-" in their name.
 */
export const CUSTOM_HTML_TAGS: string[] = ["instagram-post"]

/**
 * Custom HTML attributes supported by our CMS.
 */
export const CUSTOM_HTML_ATTRIBUTES: string[] = [
  "post-id", // custom attribute for instagram-post tag
  "captioned", // custom attribute for instagram-post tag
]

/**
 * Retrieve the HTML for embedding an Instagram post
 * @param postId the ID of the Instagram post
 * @param isCaptioned whether to include the post caption
...
/**
 * Processes the given HTML chunk by converting the custom Instagram tag
 * into the appropriate HTML for embedding the Instagram post.
 * Refer to getInstagramEmbedTag() for the custom tag format.
 * @param html the HTML chunk to process
 * @returns the processed HTML chunk
 */
export const processInstagramTagToEmbed = (html: string): string => {
...
/**
 * Processes the given HTML chunk by converting the raw HTML code for
 * embedding an Instagram post into the custom HTML tag format suitable
 * for the Markdown editor.
 * Refer to getInstagramEmbedCode() for the raw HTML code format.
 * @param html the HTML chunk to process
 * @returns the processed HTML chunk
 */
export const processInstagramEmbedToTag = (html: string): string => {
  const $ = cheerio.load(html, null, false)
