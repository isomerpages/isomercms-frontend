...
const IMAGES_DIRECTORY_REGEX = "^(/images/).+$"
...
export const imagesDirectoryRegexTest = RegExp(IMAGES_DIRECTORY_REGEX)
...
// ===============
// Highlights
export const HIGHLIGHTS_TITLE_MIN_LENGTH = 0
export const HIGHLIGHTS_TITLE_MAX_LENGTH = 60
export const HIGHLIGHTS_DESCRIPTION_MIN_LENGTH = 0
export const HIGHLIGHTS_DESCRIPTION_MAX_LENGTH = 30
// Dropdown Elems
export const DROPDOWNELEM_TITLE_MIN_LENGTH = 0
export const DROPDOWNELEM_TITLE_MAX_LENGTH = 30
// Resources
export const RESOURCES_TITLE_MIN_LENGTH = 0
export const RESOURCES_TITLE_MAX_LENGTH = 60
export const RESOURCES_SUBTITLE_MIN_LENGTH = 0
export const RESOURCES_SUBTITLE_MAX_LENGTH = 30
export const RESOURCES_BUTTON_MIN_LENGTH = 0
export const RESOURCES_BUTTON_MAX_LENGTH = 30
// Infobar
export const INFOBAR_TITLE_MIN_LENGTH = 0
export const INFOBAR_TITLE_MAX_LENGTH = 60
export const INFOBAR_SUBTITLE_MIN_LENGTH = 0
export const INFOBAR_SUBTITLE_MAX_LENGTH = 30
export const INFOBAR_BUTTON_MIN_LENGTH = 0
export const INFOBAR_BUTTON_MAX_LENGTH = 30
export const INFOBAR_DESCRIPTION_MIN_LENGTH = 0
export const INFOBAR_DESCRIPTION_MAX_LENGTH = 160
// Infopic
export const INFOPIC_TITLE_MIN_LENGTH = 0
export const INFOPIC_TITLE_MAX_LENGTH = 60
export const INFOPIC_SUBTITLE_MIN_LENGTH = 0
export const INFOPIC_SUBTITLE_MAX_LENGTH = 30
export const INFOPIC_BUTTON_MIN_LENGTH = 0
export const INFOPIC_BUTTON_MAX_LENGTH = 30
export const INFOPIC_DESCRIPTION_MIN_LENGTH = 0
export const INFOPIC_DESCRIPTION_MAX_LENGTH = 160
export const INFOPIC_ALT_MIN_LENGTH = 0
export const INFOPIC_ALT_MAX_LENGTH = 30
// Hero
export const HERO_TITLE_MIN_LENGTH = 0
export const HERO_TITLE_MAX_LENGTH = 60
export const HERO_SUBTITLE_MIN_LENGTH = 0
export const HERO_SUBTITLE_MAX_LENGTH = 160
export const HERO_BUTTON_MIN_LENGTH = 0
export const HERO_BUTTON_MAX_LENGTH = 30
export const HERO_DROPDOWN_TITLE_MIN_LENGTH = 0
export const HERO_DROPDOWN_TITLE_MAX_LENGTH = 30
