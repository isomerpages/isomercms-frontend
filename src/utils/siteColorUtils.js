...
const createPageStyleSheet = (repoName, primaryColor, secondaryColor) => {
  ...
  customStyleSheet.insertRule(
    `.bp-section.bp-section-pagetitle { background-color: ${primaryColor} !important;}`,
    0
  )

  // EditHomepage: key highlights - primary color
  customStyleSheet.insertRule(
    `#key-highlights { background-color: ${primaryColor} !important;}`,
    0
  )
  customStyleSheet.insertRule(
  ...
  customStyleSheet.insertRule(
    `.bp-sec-button span { color: ${secondaryColor} !important; border-bottom: 2px solid ${secondaryColor} !important}`,
    0
  )
  customStyleSheet.insertRule(
    `.bp-sec-button:hover span { color: ${secondaryColor} !important; border-bottom: 2px solid ${secondaryColor} !important}`,
    0
  )
  customStyleSheet.insertRule(
    `.bp-sec-button .sgds-icon { color: ${secondaryColor} !important;}`,
    0
  )
  customStyleSheet.insertRule(
    `.bp-sec-button .sgds-icon:before { color: ${secondaryColor} !important;}`,
    0
  )

  // EditPage: headings - secondary color
  customStyleSheet.insertRule(
    `.content h1 strong { color: ${secondaryColor} !important;}`,
    0
  )
  customStyleSheet.insertRule(
    `.content h2 strong { color: ${secondaryColor} !important;}`,
    0
  )
  customStyleSheet.insertRule(
    `.content h3 strong { color: ${secondaryColor} !important;}`,
    0
  )
  customStyleSheet.insertRule(
    `.content h4 strong { color: ${secondaryColor} !important;}`,
    0
  )
  customStyleSheet.insertRule(
  ...
  customStyleSheet.insertRule(
    `.bp-menu-list a.is-active { color: ${secondaryColor} !important; border-bottom: 2px solid ${secondaryColor} !important}`,
    0
  )
  customStyleSheet.insertRule(
    `.bp-menu-list a.is-active:hover { color: ${secondaryColor} !important; border-bottom: 2px solid ${secondaryColor} !important}`,
    0
  )
  customStyleSheet.insertRule(
    `.bp-menu-list a:hover { color: ${secondaryColor} !important; border-bottom: 2px solid ${secondaryColor} !important}`,
    0
  )
  customStyleSheet.insertRule(
...
export { defaultSiteColors, createPageStyleSheet, getSiteColors }
