import { DirectoryCreationModal } from "components/DirectoryCreationModal/DirectoryCreationModal"
...
import { PageMoveScreen } from "layouts/screens/PageMoveScreen"
    ...
    <>
      ...
      <div className={elementStyles.wrapper}>
        ...
        <div className={contentStyles.mainSection}>
          ...
          {/* Breadcrumb */}
          <div className={contentStyles.segment}>
            <Breadcrumb params={params} isLink />
          </div>
          {/* Creation buttons */}
          ...
          <div className={contentStyles.contentContainerBars}>
            <div className={contentStyles.boxesContainer}>
              <div className={mediaStyles.mediaCards}>
                {/* Media */}
                {mediasData ? (
                  mediasData.map((media, mediaItemIndex) => (
                    <MediaCard
                      type={mediaType}
                      media={media}
