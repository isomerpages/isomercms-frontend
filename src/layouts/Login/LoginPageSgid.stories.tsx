...
import { LoginPageSgid } from "./LoginPageSgid"

const SEND_OTP_ENDPOINT = `**/auth/login`
const VERIFY_OTP_ENDPOINT = `**/auth/verify`
const LOGOUT_ENDPOINT = `**/auth/logout`

const LoginPageSgidMeta = {
  title: "Pages/LoginPageSgid",
  component: LoginPageSgid,
  parameters: {
...
} as ComponentMeta<typeof LoginPageSgid>

const Template: ComponentStory<typeof LoginPageSgid> = LoginPageSgid
...
export default LoginPageSgidMeta
