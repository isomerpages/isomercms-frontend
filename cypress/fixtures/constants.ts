...
export const COOKIE_NAME = Cypress.env("COOKIE_NAME")
export const COOKIE_VALUE = Cypress.env("COOKIE_VALUE")
...
export const TEST_REPO_NAME = Cypress.env("TEST_REPO_NAME")
