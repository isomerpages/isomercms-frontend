...
describe("Pages flow", () => {
  ...
  const PARSED_EDITED_TEST_SUBFOLDER_WITH_PAGES_TITLE = slugifyCategory(
    EDITED_TEST_SUBFOLDER_WITH_PAGES_TITLE
  )
  const PRETTIFIED_EDITED_SUBFOLDER_WITH_PAGES_TITLE = deslugifyDirectory(
    PARSED_EDITED_TEST_SUBFOLDER_WITH_PAGES_TITLE
  )
  ...
  describe("Create folder/subfolder, rename folder/subfolder, delete folder/subfolder", () => {
    ...
    it("Should be able to create a new folder with valid folder name with no pages", () => {
      ...
      cy.url().should(
        "include",
        `${CMS_BASEURL}/sites/${TEST_REPO_NAME}/folder/${PARSED_TEST_FOLDER_NO_PAGES_TITLE}`
      )
    ...
    it("Should be able to create a new folder with valid folder name with page", () => {
      ...
      cy.url().should(
        "include",
        `${CMS_BASEURL}/sites/${TEST_REPO_NAME}/folder/${PARSED_TEST_FOLDER_WITH_PAGES_TITLE}`
      )
      cy.contains(PRETTIFIED_PAGE_TITLE, { timeout: CUSTOM_TIMEOUT })
        .should("exist")
        .click()
    ...
    it("Should be able to create a new sub-folder within a valid folder name with no pages", () => {
      ...
      cy.url().should(
        "include",
        `${CMS_BASEURL}/sites/${TEST_REPO_NAME}/folder/${PARSED_TEST_FOLDER_NO_PAGES_TITLE}/subfolder/${PARSED_TEST_SUBFOLDER_NO_PAGES_TITLE}`
      )
    ...
    it("Should be able to create a new sub-folder within a valid folder name with one page", () => {
      ...
      cy.url().should(
        "include",
        `${CMS_BASEURL}/sites/${TEST_REPO_NAME}/folder/${PARSED_TEST_FOLDER_WITH_PAGES_TITLE}/subfolder/${PARSED_TEST_SUBFOLDER_WITH_PAGES_TITLE}`
      )
    ...
    it("Should be able to rename a sub-folder", () => {
      ...
      cy.url().should(
        "include",
        `${CMS_BASEURL}/sites/${TEST_REPO_NAME}/folder/${PARSED_TEST_FOLDER_WITH_PAGES_TITLE}/subfolder/${PARSED_EDITED_TEST_SUBFOLDER_WITH_PAGES_TITLE}`
      )
      cy.contains(PRETTIFIED_PAGE_TITLE).click()
      cy.get(".CodeMirror-scroll").should("contain", TEST_PAGE_CONTENT)
    })
    ...
    it("Should be able to rename a folder", () => {
      ...
      cy.url().should(
        "include",
        `${CMS_BASEURL}/sites/${TEST_REPO_NAME}/folder/${PARSED_EDITED_TEST_FOLDER_WITH_PAGES_TITLE}`
      )
      ...
      cy.url().should(
        "include",
        `${CMS_BASEURL}/sites/${TEST_REPO_NAME}/folder/${PARSED_EDITED_TEST_FOLDER_WITH_PAGES_TITLE}/subfolder/${PARSED_EDITED_TEST_SUBFOLDER_WITH_PAGES_TITLE}`
      )
      cy.contains(PRETTIFIED_PAGE_TITLE).click()
      cy.get(".CodeMirror-scroll").should("contain", TEST_PAGE_CONTENT)
    })
  ...
  describe("Create page, delete page, edit page settings in folder", () => {
    ...
    it("Should be able to edit existing page details with valid title and permalink", () => {
      ...
      cy.get("#title").clear().type(EDITED_TEST_PAGE_TITLE)
      cy.contains("button", "Save").click()
      cy.contains("Successfully updated page settings!", {
        timeout: CUSTOM_TIMEOUT,
      }).should("exist")
